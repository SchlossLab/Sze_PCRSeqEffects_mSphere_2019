...
\textbf{Table S3: Kruskal-Wallis Results of Differences in Error Rate,
Sequences with an Error, and Chimera Prevalence between HiFi DNA
Polymerases in Mock Samples}
...
\textbf{Table S4: Dunn's Post-Hoc Results of Differences in Error Rate,
Sequences with an Error, and Chimera Prevalence between HiFi DNA
Polymerases in Mock Samples}
