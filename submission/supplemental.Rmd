...
**Table S1: ANOVA results of differences in number of OTUs between polymerases in fecal and mock samples**
...
**Table S2: Tukey post-hoc results of differences in number of OTUs between polymerases in fecal and mock samples**
...
**Table S3: Kruskal-Wallis results of differences in error rate, sequences with an error, and chimera prevalence between polymerases in mock samples**
...
**Table S4: Dunn's Post-Hoc results of differences in error rate, sequences with an error, and chimera prevalence between polymerases in mock samples**
