...
***Prevalence of Chimeric Sequences are Polymerase Dependent and Correlate with the Number of OTUs:***  Based on the previous results, we examined whether chimeras also were dependent on polymerase and whether this could affect the number of OTUs. 
