...
***16S rRNA gene sequencing counts do not differ by GC content:*** Although the 16S rRNA gene sequencing counts varied by polymerase used, there was no difference between V4 16S rRNA genes with high and low GC content at every amplification cycle [Figure 1 & Table S1]. Additionally, there was also no difference in 16S rRNA gene sequencing counts between high and low GC content genomes [Table S2].
