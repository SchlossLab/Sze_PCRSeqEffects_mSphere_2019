...
* Something like... our results suggest that the number of rounds and to a lesser degree the choice of DNA polymerase used in PCR impact the sequence data, the effects are consistent and are smaller than the biological differences between individuals

* be consistent within a study; do not interpret values like richness in absolute, but relative terms; take care in comparing results across studies

* GC, sequence length non-issues

* Other factors to investigate include impact of phylogenetic diversity, shearing, extension time, interactions of factors probably precludes ability to make definitive decisions.

* Interpret results in light of polymerase characteristics - Accuprime and Platinum have error rates that are ~10-times lower than that of Taq whereas Phusion, Q5, and Kappa are >100 times lower. These error rates track well with what we saw for sequencing error rates
