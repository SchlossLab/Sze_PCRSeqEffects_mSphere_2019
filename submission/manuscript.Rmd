...
**Conclusions.** Although there are 16S rRNA gene sequencing differences based on polymerase and number of cycles used, they are small with respect to the biological differences between fecal bacterial communities within individuals. Collectively, these results provide evidence that a real biological difference between groups, based on 16S rRNA gene sequencing of fecal samples, should be detectable regardless of polymerase and number of cycles used.  
