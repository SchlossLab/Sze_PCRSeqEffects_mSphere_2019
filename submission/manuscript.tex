...
5{]}. Interestingly, Accuprime\textsuperscript{TM} not only had one of
the lowest chimera prevalence but also consistently had the lowest
correlations between the number of OTUs and chimeric sequences {[}Figure
5{]}.
