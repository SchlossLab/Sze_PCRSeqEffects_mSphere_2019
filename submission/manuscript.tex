...
\section{Error Introduced into 16S rRNA Gene Sequencing Varies by High
Fidelity DNA Polymerase
Used}\label{error-introduced-into-16s-rrna-gene-sequencing-varies-by-high-fidelity-dna-polymerase-used}
...
polymerase and number of cycle dependent differences in the Bray-Curtis
index, error rate, sequence error prevalence, chimera prevalence, and
the correlation between chimera prevalence and number of OTUs.
...
HiFi DNA polymerase used at 35 cycles (P-value \textless{} 0.0001). When
...
Phusion = 14 - 73). Chimera prevalence in mock communities varied by
...
having the worst (R\textsuperscript{2} = 0.478).
