...
levels (1000, 5000, 10000, and 15000) while the mock community samples
were analysed at 3 levels (1000, 5000, 10000).
...
polymerase but dependent on sub-sampling depth (sub-sampled to 1000 =
0.51 (0.4 - 0.79) (median (25\% - 75\% quantile)), sub-sampled to 5000 =
0.43 (0.33 - 0.63), sub-sampled to 10000 = 0.4 (0.24 - 0.43)) {[}Figure
3A{]}. Second, for the mocks, where data is available, there were larger
difference between 20x and 25x (sub-sampled to 1000 = 0.88 (0.42 -
0.91)) {[}Figure 3B{]}. However, these differences between the next 5
cycle increment do not persist once 25 cycles are reached {[}Figure
3{]}.
