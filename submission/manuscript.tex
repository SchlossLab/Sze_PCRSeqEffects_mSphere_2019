...
distance within a set of conditions varied by 0.XX to 0.XX units.
...
varied between 0.XX and 0.XX units. These data suggest that amplicon
...
available for removing residual sequencing errors (18, 39--41). These
...
(39, 41). Others recommend removing any read that has an abundance below
a specified threshold (e.g.~removing all sequences that only appear
once) (20, 39--41). This method must be approached with caution as such
...
to validate the claims they reach with any one method (42). All methods
