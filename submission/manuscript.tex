...
protocol followed was similar to that used by Kozich, \emph{et al.}
...
instead of average neighbor for OTU generation (Edgar et al., 2011;
Rognes et al., 2016; Westcott \& Schloss, 2017). Sequence error was
determined using the seq.error command on mock samples after chimera
removal and classification to the RDP to remove non-bacterial sequences
