...
\textbf{\emph{Observed relative abundance differs by GC content.}} There
was a significant difference in relative abundance between high/low GC
content based on either the V4 16S rRNA gene region or the whole genome
{[}Figure 1 \& Table S1{]}.
